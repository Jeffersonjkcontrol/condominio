...
INSERT INTO "new_User" ("ativo", "criadoEm", "email", "id", "nome", "papel", "senhaHash") SELECT "ativo", "criadoEm", "email", "id", "nome", "papel", "senhaHash" FROM "User";
DROP TABLE "User";
...
-- CreateIndex
CREATE INDEX "Notificacao_usuarioId_tipo_entidadeId_idx" ON "Notificacao"("usuarioId", "tipo", "entidadeId");
